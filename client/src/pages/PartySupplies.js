...
class PartySupplies extends Component {
    componentDidMount() {
        this.props.categoryProducts('party supplies');
    }
    ...
    render() {
        return (
            <Fragment>
                ...
                <Header />
                <hr />
                <Container title="Party Supplies" category="party supplies"  />
            </Fragment>
        )
    }
}

PartySupplies.propTypes = {
...
export default connect(mapStateToProps, { getProducts, categoryProducts })(PartySupplies);
