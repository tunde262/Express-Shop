...
class SchoolOffice extends Component {
    componentDidMount() {
        this.props.categoryProducts('school office');
    }
    ...
    render() {
        return (
            <Fragment>
                ...
                <Header />
                <hr />
                <Container title="School & Office" category="school office"  />
            </Fragment>
        )
    }
}

SchoolOffice.propTypes = {
...
export default connect(mapStateToProps, { getProducts, categoryProducts })(SchoolOffice);
