...
import { getCustomerById, deleteCustomer, addOrder, addAddress } from '../../../actions/customerActions';
            ...
            <Fragment>
                <div class="content-box container-fluid">
                    <div class="table-responsive table-filter">
                        ...
                        <Item product={{sortedProducts: [...res], loading: false}} />
                    </div>
                </div>
            </Fragment>
        );
...
export default connect(mapStateToProps, { getCollectionById, deleteCollection, addItem, setSortedProducts, getStoreProducts })(withRouter(CustomerPage));
