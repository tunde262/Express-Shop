...
const SideDrawerProduct = ({setSlideForm1, getProductsByStoreId, storeId, product: { sortedProducts, loading }}) => {
    ...
    return (
        <Fragment>
            <div onClick={() => setSlideForm1(false)} style={{display:'flex', color:'#ff4b2b', width:'100%', padding:'1rem 0 0 1.5rem', fontSize:'0.8rem', justifyContent:'flex-start', alignItems:'center'}}>
