...
const Description = ({ slideform5, setSlideForm5, slideform6, setSlideForm6 }) => {
    return (
        <Fragment>
            <h3>Description</h3>
            ...
            <button onClick={() => setSlideForm6(!slideform6)} style={{width:'100%', outline:'none', margin:'10px 0', fontSize:'13px', letterSpacing:'1px', display:'flex', alignItems:'center', justifyContent:'center'}}>
