                ...
                <div class="product-admin-main">
                    <div class="content-box" style={{padding:'1rem 10px', display:'flex', flexDirection:'column', alignItems:'flex-start', justifyContent:'center'}}>
                        <input
                            ...
                            style={{margin:'0', width:'100%', padding:'0 10px', height:'50px', background:'#fff', fontSize:'14px', border:'2px dashed #cecece', borderRadius:'5px'}}
                        />
                    </div>
                    ...
                    <div id="order-map" style={{marginTop:'10px', width:'100%', padding:'10px 15px 10px 10px', background:'#fff', border:'2px dashed #cecece', overflow:'hidden'}}>
                        ...
                        <div style={{width:'100%', margin:'2rem 0 15px 0', height:'50px'}}>
                            <input
                                type="text"
                                name="phone"
                                className="input_line"
                                className="input_line"
                                placeholder="#"
                                style={{width:'100%', padding:'0 10px', height:'100%', background:'#fff', fontSize:'14px', border:'2px dashed #cecece', borderRadius:'5px'}}
                            />
                        </div>
