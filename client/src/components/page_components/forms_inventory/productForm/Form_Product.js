            ...
            <div className="item-form-wrapper">
                <div class="product-admin-main">
                    ...
                    <div class="content-box" style={{padding:'10px'}}>
                        <div style={{width:'100%', margin:'1rem 0', display:'grid', gridTemplateColumns:'1fr 1fr', gridGap:'1rem'}}>
                    ...
                    <div class="content-box" style={{padding:'10px'}}>
                        <div className="variant-box-form">
                ...
                <div class="product-admin-secondary">
                    ...
                    <div class="product-admin-box">
                        <div class="product-admin-box-container">
                            <p style={{color:'#808080', margin:'0'}}>Collections</p>
                            <hr style={{height:'1px', background:'rgb(214,214,214)', margin:'10px 0 10px 0'}}/>
                            <div style={{borderBottom:'1px solid #f2f2f2', width:'100%', display:'flex', alignItems:'center', justifyContent:'space-between', padding:'10px'}}>
