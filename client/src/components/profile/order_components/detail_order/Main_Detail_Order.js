        ...
        <Fragment>
            <div id="product-content-wrapper">
                ...
                <div class="product-admin-secondary">
                    ...
                    <div id="order-updates" style={{background:'#fff', margin:'10px 0 0', padding:'10px', height:'300px', border:'1px solid rgb(214, 214, 214)'}}>
                        <p>Order Summary</p>
                    ...
                    <div id="order-actions" style={{background:'#fff', margin:'0', padding:'10px', border:'1px solid rgb(214, 214, 214)'}}>
