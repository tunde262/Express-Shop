...
const Cat_Nav_Item = ({slideForm2, setSlideForm2, item, setCatValue, catValue }) => {
    ...
    return (
        <div onClick={todo} className="store-table-nav-items secondary" style={{width:'234px', margin:'10px 0', padding:'0'}}>
            <div style={{width:'234px', display: 'grid', gridTemplateColumns:'3fr 1fr', paddingLeft: '16px'}}>
